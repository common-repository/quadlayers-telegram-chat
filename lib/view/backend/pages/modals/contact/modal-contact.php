...
<div tabindex="0" id="<?php echo esc_attr( QLTGM_DOMAIN . '_modal' ); ?>" class="media-modal wp-core-ui upload-php qltgm-modal-contact processing" role="dialog" aria-modal="true" aria-labelledby="media-frame-title">
