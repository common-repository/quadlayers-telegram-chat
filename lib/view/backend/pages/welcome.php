<div class="wrap about-wrap full-width-layout">
	<div class="has-2-columns is-wider-left" style="max-width: 100%">
		...
		<div class="welcome-header">
			<h1><?php echo esc_html( QLTGM_PLUGIN_NAME ); ?> <span style="font-size: 24px;color: #555;">v<?php echo esc_html( QLTGM_PLUGIN_VERSION ); ?></span></h1>
			<div class="about-description">
			<?php esc_html_e( 'Hello we\'re QuadLayers! We\'ve recently acquired this plugin and this is the first update. We have worked very much and very hard to release it, and we will do our absolute best to support it and fix all the issues.', 'quadlayers-telegram-chat' ); ?>
			</div>
		</div>
		<hr />
	<!--       <div class="feature-section" style="margin: 15px 0;">
		...
		<div class="feature-section" style="margin: 15px 0;">
			...
			<p>
			<?php printf( esc_html__( 'If you want to get in touch with other %s users or be aware of our promotional discounts join our community now.', 'quadlayers-telegram-chat' ), esc_html( QLTGM_PLUGIN_NAME ) ); ?>
			</p>
			<a style="background-color: #ffffff;color: #626262;text-decoration: none;padding: 10px 30px;border-radius: 30px;margin: 10px 0 0 0;display: inline-block;" target="_blank" href="<?php echo esc_url( QLTGM_GROUP_URL ); ?>"><?php esc_html_e( 'Join Us', 'wp-tiktok-feed' ); ?></a>
		</div>
		<div class="feature-section" style="margin: 15px 0;">
			<h3><?php esc_html_e( 'Demo', 'quadlayers-telegram-chat' ); ?></h3>
			<p>
		...
		<div class="column">
		<img alt="<?php echo esc_html( QLTGM_PLUGIN_NAME ); ?>" src="<?php echo plugins_url( '/assets/backend/img/box.png', QLTGM_PLUGIN_FILE ); ?>">
		</div>
	</div>
</div>
